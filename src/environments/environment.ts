...
export const environment = {
  ...
  URL_Spark_socketlog: "ws://10.5.0.222:8080/?id=2-43-13",
  URL_Spark_SQL: 'http://10.5.0.222:8080/workflow/sql/',
  URL_Spark_visualisation: 'http://10.5.0.222:8080/dispatcher/visualization/',
  URL_Spark_Workflow_History: 'http://10.5.0.222:8080/workflow/workflow/?workflow_id=0',// 完整版GET http://10.5.0.222:8080/workflow/workflow/
  URL_VISUAL_CUSTOME: 'http://10.5.0.222:8080/dispatcher/custom_visualization/', // workflowId-missionID-processorID-flowID-portID
  URL_Upload_remove: "http://10.5.0.222:8080/workflow/category_delete/",
  URL_Upload_getdata: "http://10.5.0.222:8080/workflow/category/0/",
  URL_Upload_dataset: "http://10.5.0.222:8080/workflow/documents/",
  URL_Upload_save: "http://10.5.0.222:8080/workflow/category/",
  URL_Upload_File: "http://10.5.0.222:8080/workflow/processor/",
  URL_ETL_BASE: 'http://10.5.0.223:8090/TomcatTest',
  URL_ETL_newtask_rdb: 'http://10.5.0.223:8090/TomcatTest/rdb',
  URL_ETL_newtask_hdfs: 'http://10.5.0.223:8090/TomcatTest/hdfs-dir',
