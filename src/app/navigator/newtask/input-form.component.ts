...
@Component({
    selector: 'input-form',
    providers: [InputFormService, HdfsComponent],
...
export class InputFormComponent implements OnInit{
    ...
    constructor(private inputformService:InputFormService, private hdfsComponent: HdfsComponent){
    ...
    onSubmit():void { 
        this.submitted = true; 
        let result = JSON.stringify({"table_column":this.selected_table_column,"out_dir":this.hdfsComponent.out_dir, "out_format":this.hdfsComponent.out_form, "is_compress":this.hdfsComponent.is_comp, "compression_type":this.hdfsComponent.comp_type});
        alert(result); 
        this.inputformService
            .postResult(result)
            .then();
